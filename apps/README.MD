...
3. Crie um arquivo `.env` na raiz da API usando o `.env.example` como base e insira sua URL do PostgreSQL.
4. Rode as migrações com `npx prisma db push`.
5. Inicie o ambiente de desenvolvimento com `npm run dev`.
